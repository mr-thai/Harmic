...
public partial class HarmicContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TbAccount>(entity =>
        {
            ...
            entity.HasIndex(e => e.RoleId, "IX_tb_Account_RoleId");
        ...
        modelBuilder.Entity<TbBlog>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_tb_Blog_AccountId");

            entity.HasIndex(e => e.CategoryId, "IX_tb_Blog_CategoryId");
        ...
        modelBuilder.Entity<TbBlogComment>(entity =>
        {
            ...
            entity.HasIndex(e => e.BlogId, "IX_tb_BlogComment_BlogId");
        ...
        modelBuilder.Entity<TbNews>(entity =>
        {
            ...
            entity.Property(e => e.Aligo).HasMaxLength(250);
            entity.Property(e => e.CreatedBy).HasMaxLength(150);
            entity.Property(e => e.CreatedDate).HasColumnType("datetime");
            entity.Property(e => e.Description).HasMaxLength(4000);
            entity.Property(e => e.Image).HasMaxLength(500);
        ...
        modelBuilder.Entity<TbOrder>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderStatusId, "IX_tb_Order_OrderStatusId");
        ...
        modelBuilder.Entity<TbProduct>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryProductId, "IX_tb_Product_CategoryProductId");
        ...
        modelBuilder.Entity<TbProductReview>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductId, "IX_tb_ProductReview_ProductId");
