...
{
    [DbContext(typeof(HarmicContext))]
    [Migration("20251114184810_AddAccountIdToTbOrders")]
    partial class AddAccountIdToTbOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Harmic.Models.TbAccount", b =>
                {
                    ...
                    b.HasIndex(new[] { "RoleId" }, "IX_tb_Account_RoleId");
            ...
            modelBuilder.Entity("Harmic.Models.TbBlog", b =>
                {
                    ...
                    b.HasIndex(new[] { "AccountId" }, "IX_tb_Blog_AccountId");

                    b.HasIndex(new[] { "CategoryId" }, "IX_tb_Blog_CategoryId");
            ...
            modelBuilder.Entity("Harmic.Models.TbBlogComment", b =>
                {
                    ...
                    b.HasIndex(new[] { "BlogId" }, "IX_tb_BlogComment_BlogId");
            ...
            modelBuilder.Entity("Harmic.Models.TbNews", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "IX_tb_News_CategoryId");
            ...
            modelBuilder.Entity("Harmic.Models.TbOrder", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrderStatusId" }, "IX_tb_Order_OrderStatusId");
            ...
            modelBuilder.Entity("Harmic.Models.TbOrderDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrderId" }, "IX_tb_OrderDetail_OrderId");
            ...
            modelBuilder.Entity("Harmic.Models.TbProduct", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryProductId" }, "IX_tb_Product_CategoryProductId");
            ...
            modelBuilder.Entity("Harmic.Models.TbProductReview", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_tb_ProductReview_ProductId");
